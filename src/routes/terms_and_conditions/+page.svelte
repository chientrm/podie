...
<p>
	...
	languages or make derivative versions. The app itself, and all the trademarks,
	copyright, database rights, and other intellectual property rights related to
	it, still belong to Chien Tran.
</p>
<p>
	Chien Tran is committed to ensuring that the app is as useful and efficient as
...
<p>
	The Podie app stores and processes personal data that you have provided to us,
	to provide my Service. It’s your responsibility to keep your phone and access
	to the app secure. We therefore recommend that you do not jailbreak or root
	...
	your phone’s security features and it could mean that the Podie app won’t work
	properly or at all.
</p>
<div>
	<p>
...
<p>
	You should be aware that there are certain things that Chien Tran will not
	...
	your mobile network provider, but Chien Tran cannot take responsibility for
	the app not working at full functionality if you don’t have access to Wi-Fi,
...
<p>
	Along the same lines, Chien Tran cannot always take responsibility for the way
	you use the app i.e. You need to make sure that your device stays charged – if
	it runs out of battery and you can’t turn it on to avail the Service, Chien
	Tran cannot accept responsibility.
</p>
<p>
	With respect to Chien Tran’s responsibility for your use of the app, when
	...
	Chien Tran accepts no liability for any loss, direct or indirect, you
...
<p>
	...
	on – the requirements for the system(and for any additional systems we decide
	to extend the availability of the app to) may change, and you’ll need to
	download the updates if you want to keep using the app. Chien Tran does not
	promise that it will always update the app so that it is relevant to you
	and/or works with the version that you have installed on your device. However,
	you promise to always accept updates to the application when offered to you,
	We may also wish to stop providing the app, and may terminate use of it at any
...
<p>
	...
	hesitate to contact me at chientrm@gmail.com.
</p>
<p>
